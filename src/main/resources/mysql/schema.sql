...
CREATE TABLE IF NOT EXISTS `notification` (
    ...
    `related_type`  TINYINT     NOT NULL                 COMMENT 'Notification type: 0=COMMENT, 1=REPLY, 2=MOMENT_MENTION, 3=COMMENT_MENTION, 4=CHAT_MENTION',
    `related_id`    BIGINT      NOT NULL                 COMMENT 'Related target ID, e.g. comment ID when type=4',
